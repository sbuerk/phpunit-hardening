...
Options:
    -s <...>
        Specifies which test suite to run
            ...
            - endToEnd: PHPUnit end to end tests
            - lint: PHP linting
    ...
    -e "<phpunit or codeception options>"
        Only with -s unit
        Additional options to send to phpunit (unit tests). For phpunit, options starting with "--" must
        be added after options starting with "-". Example -e "-v --filter canRetrieveValueWithGP" to enable
        verbose output AND filter tests
